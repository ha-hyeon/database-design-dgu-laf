  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
        ...
        primaryColor: const Color.fromARGB(255, 255, 184, 61),
        primaryColorDark: Colors.black87,
        primaryColorLight: const Color.fromARGB(255, 255, 240, 225),
        colorScheme: ColorScheme.fromSwatch(
          backgroundColor: const Color.fromARGB(255, 255, 226, 184),
        ),
      ),
